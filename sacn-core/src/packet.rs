...
use crate::{
    e131_definitions::{
        ...
        E131_STREAM_TERMINATION_OPTION_BIT_MASK, E131_SYNC_ADDR_FIELD_LENGTH, E131_SYNC_FRAMING_LAYER_RESERVE_FIELD_LENGTH,
        E131_SYNC_FRAMING_LAYER_SEQ_NUM_FIELD_LENGTH, E131_UNIVERSE_DISCOVERY_FRAMING_LAYER_MIN_LENGTH,
        E131_UNIVERSE_DISCOVERY_LAYER_MAX_LENGTH, E131_UNIVERSE_DISCOVERY_LAYER_MIN_LENGTH, E131_UNIVERSE_FIELD_LENGTH,
        E131_UNIVERSE_SYNC_PACKET_FRAMING_LAYER_LENGTH, MAXIMUM_PACKET_SIZE, UNIVERSE_CHANNEL_CAPACITY, VECTOR_DMP_SET_PROPERTY,
        VECTOR_E131_DATA_PACKET, VECTOR_E131_EXTENDED_DISCOVERY, VECTOR_E131_EXTENDED_SYNCHRONIZATION, VECTOR_ROOT_E131_DATA,
...
const PRIORITY_INDEX: usize = SOURCE_NAME_INDEX + SourceName::CAPACITY;
...
impl Pdu for DataPacketFramingLayer {
    ...
    fn pack(&self, buf: &mut [u8]) -> Result<(), ParsePackError> {
        ...
        zeros(&mut buf[SOURCE_NAME_INDEX..PRIORITY_INDEX], SourceName::CAPACITY);
